...
CONFIG.PROCGEN_CURSED_ROOM_COUNT = 1
CONFIG.PROCGEN_SPIKE_MIN = 2
CONFIG.PROCGEN_SPIKE_MAX = 8
CONFIG.PROCGEN_SPIKE_MULTIPLIER = 0.75

CONFIG.SHRINE_RADIUS = 42
CONFIG.SAFE_ZONE_PADDING = 20

CONFIG.SPIKE_ACTIVE_TIME = 0.8
CONFIG.SPIKE_INACTIVE_TIME = 1.2
...
CONFIG.SANITY_CURSED_ROOM_SHOCK = 16
